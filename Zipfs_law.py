...
"""
# best practice is to import all packages in the top
import requests
import string
...
# def means that we are doing a function
...
# useful thing is that you can import defs in other scripts by 
# saying: from Zipfs_law import tokenize
